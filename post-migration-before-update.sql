...
delete from ir_ui_view where inherit_id in ( select id from ir_ui_view where arch_db like '%shipment_count%');
...
-- El campo `in_group_18` no existe
delete from ir_ui_view where inherit_id in (153);
delete from ir_ui_view where id in (153);